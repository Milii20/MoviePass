...
<div class="cuerpochico">
    ...
    <form action="<?php if ($tipo=="crear") {echo FRONT_ROOT."Admin/CrearCinema";} else {echo FRONT_ROOT."Admin/ModificarCinema";}?>" method="post">
            ...
            <input  type="number" name="capacidadtotal" min="0" max="5000" placeholder="Capacidad Total" <?php if ($tipo=="modificar") echo 'value="'.$cinemaMod->getCapacidadTotal().'"'; ?> required> <br>
            <input  type="number" name="cantgenteporfila" min="0" max="500" placeholder="Cant de Gente por Fila" <?php if ($tipo=="modificar") echo 'value="'.$cinemaMod->getcantGentePorFila().'"'; ?> required> <br>
